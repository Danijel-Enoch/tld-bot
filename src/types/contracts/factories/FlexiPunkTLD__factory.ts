...
import type { FlexiPunkTLD, FlexiPunkTLDInterface } from "../FlexiPunkTLD";
...
export class FlexiPunkTLD__factory {
  static readonly abi = _abi;
  static createInterface(): FlexiPunkTLDInterface {
    return new Interface(_abi) as FlexiPunkTLDInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): FlexiPunkTLD {
    return new Contract(address, _abi, runner) as unknown as FlexiPunkTLD;
  }
}
